...
@Component
public class WhichSenderToRun implements ApplicationRunner {

  private static final Logger LOG = LoggerFactory.getLogger(WhichSenderToRun.class);

  private final List<Sender> everySender;
  private final String wanted;

  public WhichSenderToRun(List<Sender> everySender, @Value("${rtat.send:}") String wanted) {
