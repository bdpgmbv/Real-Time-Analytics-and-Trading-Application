...
public final class RealDatabase {
    ...
    public static JdbcTemplate readyToUse() {
        ...
        SharedPostgres.applyOnce("position-pk", "ALTER TABLE position ADD PRIMARY KEY (account_id, product_id)");
        SharedPostgres.applyOnce("price-pk", "ALTER TABLE price ADD PRIMARY KEY (product_id, price_date)");
