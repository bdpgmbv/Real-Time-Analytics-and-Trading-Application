...
class PushToTheScreensTest {
  ...
  private WhoIsWatching watching;
  private SomethingChanged changes;
  private ExposureCalculator calculator;
  private SimpleMeterRegistry meters;
  private PushToTheScreens pushing;

  @BeforeEach
  void setUp() {
    watching = mock(WhoIsWatching.class);
    changes = new SomethingChanged();
    calculator = mock(ExposureCalculator.class);
    meters = new SimpleMeterRegistry();
    pushing = new PushToTheScreens(watching, changes, calculator, meters);
  }
