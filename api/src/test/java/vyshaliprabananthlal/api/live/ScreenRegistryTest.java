...
class WhoIsWatchingTest {
    ...
    void differentFundsAreKeptApart() {
        ...
        assertThat(watching.watchedFunds()).containsExactlyInAnyOrder(1, 2);
    }
    ...
    void aClosedBrowserIsDropped() throws IOException {
        ...
        doThrow(new IOException("broken pipe")).when(goneAway).send(any(SseEmitter.SseEventBuilder.class));
