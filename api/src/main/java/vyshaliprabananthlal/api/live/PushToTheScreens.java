...
@Component
public class PushToTheScreens {

  private static final Logger LOG = LoggerFactory.getLogger(PushToTheScreens.class);

  static final String THE_EVENT_NAME = "exposure";

  private final WhoIsWatching watching;
  private final SomethingChanged changes;
