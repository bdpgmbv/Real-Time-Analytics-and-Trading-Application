...
@Component
public class WarmUpTheTokenKeys implements ApplicationRunner {

  private static final Logger LOG = LoggerFactory.getLogger(WarmUpTheTokenKeys.class);

  private static final String A_TOKEN_THAT_CANNOT_BE_VALID = "warm.up.only";

  private final JwtDecoder decoder;

  public WarmUpTheTokenKeys(JwtDecoder decoder) {
