...
class TradeListenerTest {
    ...
    void startWithOnePosition() {
        listener = new TradeListener(new KafkaBatch(database, new SimpleMeterRegistry()), new JsonReader(), new Sql());
    ...
    void aTradeMovesThePosition() {
        listener.arrived(List.of(aTrade(1, 200)), kafka);
    ...
    void aSaleReducesThePosition() {
        listener.arrived(List.of(aTrade(1, -300)), kafka);
    ...
    void differentTradesAllApply() {
        listener.arrived(List.of(aTrade(1, 100), aTrade(2, 100), aTrade(3, 100)), kafka);
