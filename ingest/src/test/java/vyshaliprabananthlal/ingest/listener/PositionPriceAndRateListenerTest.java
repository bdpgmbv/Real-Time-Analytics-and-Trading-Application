...
class PositionPriceAndRateListenerTest {
  ...
  void positionIsSetNotAdded() {
    PositionListener listener = new PositionListener(database, new Messages());
  ...
  void priceIsUpdated() {
    PriceListener listener = new PriceListener(database, new Messages());
  ...
  void rateIsUpdatedAndMarked() {
    RateListener listener = new RateListener(database, new Messages());
