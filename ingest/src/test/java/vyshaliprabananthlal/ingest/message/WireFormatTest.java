...
class WireFormatTest {
  ...
  void priceFieldsAreFixed() {
    JsonNode fields =
        reading.read("{\"productId\":100101,\"price\":189.32,\"howFresh\":\"DELAYED 20 MINUTES\"}");
  ...
  void tradeFieldsAreFixed() {
    JsonNode fields =
        reading.read(
            "{\"tradeId\":77,\"accountId\":340,\"productId\":100102,\"howMany\":-500,"
  ...
  void hedgeFillFieldsAreFixed() {
    JsonNode fields =
        reading.read(
            "{\"fillId\":1,\"hedgeId\":500,\"amountFilled\":9000000,\"rate\":1.154,"
  ...
  void unknownFieldsAreIgnored() {
    JsonNode fields =
        reading.read("{\"productId\":1,\"price\":2.5,\"somethingAddedLater\":\"whatever\"}");
